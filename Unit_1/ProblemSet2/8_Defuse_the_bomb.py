...
His butler, Alfred, is on the phone providing him 
with a circular array code of length n and key k.
...
Given the circular array code and 
an integer key k, write a function decrypt() that returns the decrypted code to defuse the bomb!
