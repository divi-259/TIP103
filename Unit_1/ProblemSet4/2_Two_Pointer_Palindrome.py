'''
Write a function is_palindrome() that takes in a string s as a parameter and returns 
...
which is a common technique in which we initialize two variables (also called a pointer in this context) to track different indices or places in a list or string, 
